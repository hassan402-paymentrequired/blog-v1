    ...
    <div>
        ...
        <div class="flex flex-col gap-3">
            ...
            <div class="flex items-center justify-between gap-3 px-6 py-3  bg-neutral-800 rounded border w-full ">
               ...
               <div class="space-x-4 ">
                   <a href="/edit" class="text-sm text-slate-300 font-bold px-4 py-1 rounded bg-gray-600 ">Edit</a>
                   <a href="/delete" class="text-sm text-slate-300 font-bold px-4 py-1 rounded bg-gray-600 ">Delete</a>
               </div>
