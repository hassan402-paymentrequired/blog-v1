<div class="flex-[3]">
    <div class="w-full border-b-[1px] border-gray-700 mb-2 ">
        <span class="px-4 py-0.5 text-black bg-gray-600 font-bold ">Feed</span>
    </div>
    <!-- component /<//?//php// echo $post['post_id']?>" -->
    <div class="h-screen overflow-auto relative outline-0" style="scrollbar-width: none">
        <?php foreach ($data as $post): ?>
            <div class="w-full  bg-neutral-800 mt-4 rounded parent">
                ...
                <form class="w-[90%] mx-auto mb-5 pb-2" action="/home/comment/create" method="POST">
                    <div class="flex items-center border-b  py-2 px-2">
                        <input class="appearance-none bg-transparent border-none w-full text-gray-300 mr-3 py-1 px-2 leading-tight focus:outline-none"
                               type="text" placeholder="comment..." aria-label="comment" name="comment">
                        <input type="hidden" value="<?php echo $post['post_id'] ?>" name="id">
                        <button <?php ?>
                                class="flex-shrink-0 bg-neutral-800 border-gray-500  text-sm border-4 text-white py-1 px-2 rounded"
